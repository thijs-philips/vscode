		...
		const deps = (await Promise.all([
			glob('**/*.node', {
				...
				ignore: [
					...
					// Skip non-win32 native modules that vendored SDKs (copilot, claude, etc.)
					// ship under platform/arch subfolders. rcedit cannot patch ELF/Mach-O.
					'**/{prebuilds,vendor,bin,native}/**/*linux*/**',
					'**/{prebuilds,vendor,bin,native}/**/*darwin*/**',
					'**/{prebuilds,vendor,bin,native}/linux-*/**',
					'**/{prebuilds,vendor,bin,native}/darwin-*/**',
					'**/{prebuilds,vendor,bin,native}/*-linux/**',
					'**/{prebuilds,vendor,bin,native}/*-darwin/**',
