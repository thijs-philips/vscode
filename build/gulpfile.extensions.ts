...
const compilations = [
	...
	'extensions/markdown-menu/tsconfig.json',
	'extensions/terminal-suggest/tsconfig.json',
	'extensions/text-toolkit/tsconfig.json',
	'extensions/toolbar-sample/tsconfig.json',
	'extensions/project-build/tsconfig.json',
