...
import { CopilotVisionPatchContribution } from './actions/chatCopilotVisionPatch.js';
...
registerWorkbenchContribution2(CopilotVisionPatchContribution.ID, CopilotVisionPatchContribution, WorkbenchPhase.Eventually);
